...
describe("buildEditCatalogs", () => {
  ...
  it("exposes existing deities (name_ja-keyed) with canonical info for the create picker", () => {
    ...
    expect(catalogs.deities).toEqual([
      { id: "deity-1", name_en: "Deity One", name_ja: "神一", deity_type: "mythological", titles: ["Lord of the Sun", "Divine Ancestor"], canonical_lore: "canon-1" },
      { id: "deity-3", name_en: "Deity Three", name_ja: "神三", deity_type: "mythological", titles: ["Unenshrined Spirit"], canonical_lore: "canon-3" },
      { id: "deity-2", name_en: "Deity Two", name_ja: "神二", deity_type: "mythological", titles: ["Guardian of the Sea"], canonical_lore: "canon-2" },
    ]);
  });
});
