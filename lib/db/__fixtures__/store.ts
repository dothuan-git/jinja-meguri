...
export function makeStore(): Store {
  return {
    ...
    deities: [
      { id: "deity-1", name_en: "Deity One", name_ja: "神一", titles: ["Lord of the Sun", "Divine Ancestor"], titles_ja: null, deity_type: "mythological", canonical_lore: "canon-1", canonical_lore_ja: null, mythic_sphere: null, mythic_sphere_ja: null },
      { id: "deity-2", name_en: "Deity Two", name_ja: "神二", titles: ["Guardian of the Sea"], titles_ja: null, deity_type: "mythological", canonical_lore: "canon-2", canonical_lore_ja: null, mythic_sphere: null, mythic_sphere_ja: null },
      { id: "deity-3", name_en: "Deity Three", name_ja: "神三", titles: ["Unenshrined Spirit"], titles_ja: null, deity_type: "mythological", canonical_lore: "canon-3", canonical_lore_ja: null, mythic_sphere: null, mythic_sphere_ja: null },
    ],
    shrines: [
      { id: "shrine-a", slug: "a", name_en: "Shrine A", name_ja: "甲社", prefecture_id: 1, region_id: 1, city: "Saitama", city_ja: null, address: "addr-a", address_ja: null, coordinates: { lat: 35.9, lng: 139.6 }, image_urls: null },
      { id: "shrine-b", slug: "b", name_en: "Shrine B", name_ja: "乙社", prefecture_id: 2, region_id: 2, city: "Kyōto", city_ja: null, address: null, address_ja: null, coordinates: null, image_urls: null },
    ],
    shrine_deities: [
    ...
    festivals: [
      { id: "festival-1", shrine_id: "shrine-a", name_en: "Grand Festival", name_ja: "大祭", time_prose: "early August", time_prose_ja: null, start_date: "2026-07-30", end_date: "2026-08-02", origin: "o", origin_ja: null, meaning: "m", meaning_ja: null, ritual: "r", ritual_ja: null, prayer: "p", prayer_ja: null, festival_type: "spectacle", visitor_notes: "v", visitor_notes_ja: null, sort_order: 0 },
      { id: "festival-2", shrine_id: "shrine-b", name_en: "Lunar Rite", name_ja: "旧暦祭", time_prose: "2nd Sunday of the 6th lunar month", time_prose_ja: null, start_date: null, end_date: null, origin: "o2", origin_ja: null, meaning: "m2", meaning_ja: null, ritual: "r2", ritual_ja: null, prayer: "p2", prayer_ja: null, festival_type: "pilgrimage", visitor_notes: "v2", visitor_notes_ja: null, sort_order: 0 },
    ],
    sources: [
