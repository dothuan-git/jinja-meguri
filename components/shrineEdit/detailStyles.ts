...
export const typo = {
  ...
  sectionTitle: "text-xl md:text-2xl font-serif font-black text-stone",
  subheading: "text-lg md:text-xl font-serif font-black text-stone leading-tight",
  ...
  quote: "text-sm md:text-base font-quote italic text-stone/85 leading-relaxed border-l-2 border-torii/30 pl-4",
